            ...
            <div class="">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Input Data Materi</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('dataObat.create') }}" method="post" enctype="multipart/form-data">
                            @csrf
